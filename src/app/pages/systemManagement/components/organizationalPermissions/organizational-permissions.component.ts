...
@Component({
    selector: 'organizational-permissions',
    encapsulation: ViewEncapsulation.None,
    // styleUrls: ['./apply-permissions.component.scss'],
    styleUrls: ['../../systemManagement.component.scss'],
    templateUrl: './organizational-permissions.component.html'
})
export class OrganizationalPermissionsComponent implements OnInit {
    ...
    editRole(role): void {
        ...
        this.router.navigate(
            ['/pages/systemManagement/administratorManagement/administratorPermissions/organizationalPermissions/view',
