...
import { QuadrantXTicksComponent } from './quadrant-x-ticks.component';

@Component({
  selector: 'g[ngx-quadrant-x-axis]',
  template: `
	<svg:g
		[attr.class]="xAxisClassName"
		[attr.transform]="transform">
		<svg:g ngx-quadrant-x-ticks
			*ngIf="xScale"
...
export class QuadrantXAxisComponent implements OnChanges {
	// property
	...
	@ViewChild(QuadrantXTicksComponent) ticksComponent: QuadrantXTicksComponent;
